...
.L10:
 ...
 add DWORD PTR -52[rbp], 1 # -52 - i
.L9:
 mov eax, DWORD PTR -132[rbp] # -132 - length
 cmp DWORD PTR -52[rbp], eax # -52 - i
 jl .L10
 mov rax, QWORD PTR -80[rbp] # -80 - input
 mov rdi, rax
 call fclose@PLT
 mov ecx, DWORD PTR -136[rbp] # -136 - X
 mov esi, DWORD PTR -132[rbp] # -132 - length
 mov rdx, QWORD PTR -112[rbp] # -112 - Массив B
 mov rax, QWORD PTR -96[rbp] # -96 - Массив А
 mov rdi, rax
 call Task@PLT
 mov DWORD PTR -116[rbp], eax # -116 - size_b 
 lea rax, .LC3[rip]
 mov rsi, rax
 lea rax, .LC4[rip]
 mov rdi, rax
 ...
 mov DWORD PTR -56[rbp], 0 # -56 - i в новом цикле
 jmp .L11
.L12:
 mov rax, QWORD PTR -112[rbp] # -112 - Массив B
 mov edx, DWORD PTR -56[rbp] # -56 - i в новом цикле
 movsx rdx, edx
 ...
 mov eax, 0
 call fprintf@PLT
 add DWORD PTR -56[rbp], 1 # -56 - i в новом цикле
.L11:
 mov eax, DWORD PTR -56[rbp] # -56 - i в новом цикле
...
.L14:
 ...
 mov	rdi, rax
	...
	jmp	.L20
.L15:
	mov	DWORD PTR -60[rbp], 0 # -60 - i в новом цикле 2
	jmp	.L16
.L17:
	mov	eax, DWORD PTR -60[rbp] # -60 - i в новом цикле 2
	mov	esi, eax
	lea	rax, .LC9[rip]
	mov	rdi, rax
	mov	eax, 0
	...
	mov	eax, 0
	call	__isoc99_scanf@PLT
	add	DWORD PTR -60[rbp], 1 # -60 - i в новом цикле 2
.L16:
	mov	eax, DWORD PTR -132[rbp] # -132 - length
	cmp	DWORD PTR -60[rbp], eax # -60 - i в новом цикле 2
	jl	.L17
	mov	ecx, DWORD PTR -136[rbp] # -136 - X
	mov	esi, DWORD PTR -132[rbp] # -132 - length
	lea	rdx, -224[rbp] # -224 - массив B после i
	lea	rax, -176[rbp] # -176 - массив А после if
	mov	rdi, rax
	call	Task@PLT
	mov	DWORD PTR -68[rbp], eax # -68 - b_size
	mov	DWORD PTR -64[rbp], 0 # -64 - i в новом цикле 3
	jmp	.L18
.L19:
	mov	eax, DWORD PTR -64[rbp] # -64 - i в новом цикле 3
	...
	mov	eax, 0
	call	printf@PLT
	add	DWORD PTR -64[rbp], 1 # -64 - i в новом цикле 3
.L18:
	mov	eax, DWORD PTR -64[rbp] # -64 - i в новом цикле 3
